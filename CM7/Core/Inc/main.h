...
extern volatile uint16_t 	raw_PhaseA_current[1];
extern volatile uint16_t	raw_PhaseB_current[1];
extern volatile uint16_t	raw_PhaseC_current[1];

// Processed, signed 16-bit integers after subtracting the 1.65V offset
extern volatile int16_t		PhaseA_current;
